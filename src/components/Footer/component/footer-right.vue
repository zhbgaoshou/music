...
import rSetting from "./r-setting.vue";
import { useFooterStore } from "@/store/index";
...
<template>
  ...
  <Teleport to="#app">
    <PlayList
      class="pc-plist"
      :style="{ right: footerStore.list_style_right }"
    ></PlayList>
  </Teleport>
  ...
  <Teleport to="#app">
    <PlayList
      class="m-plist"
      style="display: none"
      :style="{ height: footerStore.list_style_height }"
    ></PlayList>
  </Teleport>
</template>
